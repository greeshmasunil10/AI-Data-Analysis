...
#         if(pollcount!=0):self.prob4=round(smooth/(0+vocabsize*smooth),7)
    ...
    def updatefreq(self): 
        ...
        if(storycount!=0 and self.count1==0):self.prob1=round(smooth/(storycount+vocabsize*smooth),7)
        if(askcount!=0 and self.count2==0):self.prob2=round(smooth/(askcount+vocabsize*smooth),7)
        if(showcount!=0 and self.count3==0 ):self.prob3=round(smooth/(showcount+vocabsize*smooth),7)
        if(pollcount!=0 and self.count4==0):self.prob4=round(smooth/(pollcount+vocabsize*smooth),7)
